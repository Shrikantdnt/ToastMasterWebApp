...
try {
	...
	String validationMessage = WebUI.getText(findTestObject('Object Repository/ClubCentral/Add_Membership/No, Dual_Reinstated Member/div_validation_The member was not found'))
        ...
        GlobalVariable.varpassremarks = 'User was not found -with InvalidName and MemberEmailID'
    } else {

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User was found -with InvalidName and MemberEmailID'
    }
